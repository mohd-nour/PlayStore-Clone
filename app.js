...
>>>>>>> 29f0d8d0456fc4845dd1731c41433885594ba4fc
  ...
  subtitles:
    "Chinese (Simplified), Chinese (Traditional), Czech, Danish, Dutch, English (United Kingdom) [CC], English [CC], Finnish, Greek, Hungarian, Icelandic, Norwegian, Polish, Portuguese (Portugal), Slovak, Slovenian, Spanish (Latin America), Swedish, Thai, Turkish, Ukrainian",
...
const book1 = new Book({
  title: "Blackbird",
  mainImage:
    "https://books.google.com/books/publisher/content/images/frontcover/y-JuDwAAQBAJ?fife=w200-h300",
  creator: "Sam Humphries",
  date: "Oct 2018",
  genre: ["Sam Humphries"],
  price: "Free ebook",
  description:
    "An all-new ongoing series from fan-favorite writer SAM HUMPHRIES (Harley Quinn, Nightwing) and red-hot artist JEN BARTEL! In this neo-noir fantasy, Nina Rodriguez is positive that a secret magic world ruled by ruthless cabals is hiding just beneath the veneer of Los Angeles. The problem: everyone thinks shes crazy. The bigger problem: she's not crazy she's right. Can she unravel the mystery before the Great Beast catches up with her?",
  more:
    "Smartphones and TabletsInstall the Google Play Books app for Android and iPad/iPhone. It syncs automatically with your account and allows you to read online or offline wherever you are.Laptops and ComputersYou can read books purchased on Google Play using your computer's web browser.eReaders and other devicesTo read on e-ink devices like the Sony eReader or Barnes & Noble Nook, you'll need to download a file and transfer it to your device. Please follow the detailed Help center instructions to transfer the files to supported eReaders.",
...
const app1 = new Application({
  ...
  mainImage:
    "https://play-lh.googleusercontent.com/kFwF8Y2Ve0YRodzWIVWvz15lwfoZMPvTcJRcReO_hKyqVzTHDe9VCBU4SyxnsbOn2A=s180",
  genre: ["Century Games Pte. Ltd.", "Simulation"],
  video:
    "https://www.youtube.com/embed/-UwX0HkFQyI?ps=play&vq=large&rel=0&autohide=1&showinfo=0",
  images: [],
  description:
